    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px;
            ...
            <div>
                <img u="image" src="<?php echo get_template_directory_uri(); ?>/img/1920/red.jpg" />
                <div u="caption" t="NO" t3="RTT|2" r3="137.5%" du3="3000" d3="500" style="position: absolute; width: 445px; height: 300px; top: 100px; left: 600px;">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-phone.png" style="position: absolute; width: 445px; height: 300px; top: 0px; left: 0px;" />
                    <img u="caption" t="CLIP|LR" du="4000" t2="NO" src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-jssor-slider.png" style="position: absolute; width: 102px; height: 78px; top: 70px; left: 130px;" />
                    <img u="caption" t="ZMF|10" t2="NO" src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-text.png" style="position: absolute; width: 80px; height: 53px; top: 153px; left: 163px;" />
                    <img u="caption" t="RTT|10" t2="NO" src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-fruit.png" style="position: absolute; width: 140px; height: 90px; top: 60px; left: 220px;" />
                    <img u="caption" t="T" du="4000" t2="NO" src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-navigator.png" style="position: absolute; width: 200px; height: 155px; top: 57px; left: 121px;" />
                </div>
                <div u="caption" t="RTT|2" r="-75%" du="1600" d="2500" t2="NO" style="position: absolute; width: 470px; height: 220px; top: 120px; left: 650px;">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-phone-horizontal.png" style="position: absolute; width: 470px; height: 220px; top: 0px; left: 0px;" />
                    <img u="caption" t3="MCLIP|L" du3="2000" src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-slide-1.jpg" style="position: absolute; width: 379px; height: 213px; top: 4px; left: 45px;" />
                    <img u="caption" t="MCLIP|R" du="2000" t2="NO" src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-slide-3.jpg" style="position: absolute; width: 379px; height: 213px; top: 4px; left: 45px;" />
                    <img u="caption" t="RTTL|BR" x="500%" y="500%" du="1000" d="-3000" r="-30%" t3="L" x3="70%" du3="1600" src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-finger-pointing.png" style="position: absolute; width: 257px; height: 300px; top: 80px; left: 200px;" />
                    <img src="<?php echo get_template_directory_uri(); ?>/img/new-site/c-navigator-horizontal.png" style="position: absolute; width: 379px; height: 213px; top: 4px; left: 45px;" />
                </div>
            ...
            <div>
                <img u="image" src="<?php echo get_template_directory_uri(); ?>/img/1920/purple.jpg" />
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; text-transform: uppercase; font-size: 50px;
                        color: #FFFFFF;">Touch Swipe Slider
                </div>
            ...
            <div>
                <img u="image" src="<?php echo get_template_directory_uri(); ?>/img/1920/blue.jpg" />
                <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                    text-align: left; line-height: 60px; text-transform: uppercase; font-size: 50px;
                        color: #FFFFFF;">Touch Swipe Slider
                </div>
        ...
        <a style="display: none" href="http://www.jssor.com">carousel slider</a>
	       ...
	       <div id="header">	
            <?php //layerslider(2) ?>	
            <?php //if (function_exists('vslider')) { vslider('vslider1'); }?>
						...
						<div class="navbar-inner">
							<div class="container">
								<ul class="nav">
									...
									<li><a href="index.php" />Offers and Promotions</a></li>
